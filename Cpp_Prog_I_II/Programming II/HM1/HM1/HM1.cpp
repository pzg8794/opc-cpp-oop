...
void getValues(); //Declearing Functiong to get grades
...
{	
	cout<<"\n\n";											// Title and Name.
	cout<<right<<setw(52)<< " HomeWork  Assignment # 1 \n" <<setw(48)<<right<< " By  Piter Garcia\n\n " ;
	cout<<"\n\n";
...
{  
	...
	int  grade, grade1,grade2,grade3,grade4,grade5;				//declearing grade's variables.
