...
cout<<"\n The Resistor equivalent from R1 to R2 is "<<Req1<<"\tKillo Ohms\n";
Req2= Parallel_Res2(Req1, R3);
cout<<"\n The Resistor equivalent from R1 to R3 is "<<Req2<<"\tKillo Ohms\n";
Req3= Parallel_Res3(Req2, R4);
cout<<"\n The Resistor equivalent from R1 to R4 is "<<Req3<<"\tKillo Ohms\n";
Req4= Parallel_Res4(Req3, R5);
cout<<"\n The Resistor equivalent from R1 to R5 is "<<Req4<<"\tKillo Ohms\n";
Req5= Parallel_Res5(Req4, R5);
cout<<"\n The Resistor equivalent from R1 to R6 is "<<Req5<<"Killo Ohms\n";
Req6= Parallel_Res6(Req5, R5);
cout<<"\n The Resistor equivalent from R1 to R7 is "<<Req6<<"\tKillo Ohms\n";
Req7= Parallel_Res7(Req6, R5);
cout<<"\n The Resistor equivalent from R1 to R8 is "<<Req7<<"\tKillo Ohms\n";
Req8= Parallel_Res8(Req7, R5);
cout<<"\n The Resistor equivalent from R1 to R9 is "<<Req8<<"Killo Ohms\n";
