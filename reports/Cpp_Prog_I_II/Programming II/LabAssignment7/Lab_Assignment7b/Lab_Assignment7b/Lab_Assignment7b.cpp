...
Then, it will dropp it and print it along with the student Grades Average:
*/
...
{	
	int i;
	int grade[50];			//declearing grade's variables.

	cout<<"\n\n";											// Title and Name.
	cout<<right<<setw(52)<< " HomeWork  Assignment # 7B \n" <<setw(48)<<right<< " By  Piter Garcia\n\n " ;
	cout<<"\n\n";
...
{  
	int r;			//declearing grade's variables.
