...
{ 
	...
	if (i>=10)
	{
		for(size=10;size<i;size++) //Adding the amount of elements in the array.
		{
...
cout<<" Please Enter the Number of Elements You wish to add to your New Array : \n ";
cin>>elements;
size+=elements;
...
cout<<"\n\n";
	...
	//-Table to display the properties of the array.
	 ...
	 cout<<setw(21)<<" Items Added....= "<<setw(5)<<right<< elements <<endl;
