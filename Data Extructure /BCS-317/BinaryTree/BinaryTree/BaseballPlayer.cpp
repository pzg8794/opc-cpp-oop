...
// Big-O runtime cost: Big-O(1)
//*************************************************************************
void BaseballPlayer::show(ostream & p)
{
	p<<" BASEBALL PLAYER DATA \n ";
					  p<<"_____________________________________________________________________________\n\n";
	p<<setw(12)<<" "<<right;
	p<<" "<<setw(7)<<right<<" Name  | "<<" At Bat(s) | "<<" Hit(S) | "<<" Home Run(s) | "<<" Average | \n  ";
			p<<setw(16)<<right<<name<<right<<"  |"<<setw(11)<<ab <<right<<" |"<<setw(8)<<right<< hits <<" |";
	p<<setw(13)<<right<< hr <<" |"<<setw(9)<<right<<Avg() <<" |\n ";
					  p<<"_____________________________________________________________________________\n\n";
